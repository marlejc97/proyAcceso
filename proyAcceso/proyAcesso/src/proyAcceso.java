 ...
 * @author NUC-LAB02
 */
public class proyAcceso extends javax.swing.JFrame {

    /**
     * Creates new form proyAcceso
     */
    public proyAcceso() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/cande.jpg"))); // NOI18N
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(btnAcceder, javax.swing.GroupLayout.DEFAULT_SIZE, 65, Short.MAX_VALUE)
    ...
    private void btnAccederActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAccederActionPerformed
        ...
        if(user.equals("Marle") && contra.equals("seven")){
             JOptionPane.showMessageDialog(null, "BIENVENIDO");
             this.setVisible(false);
             new frmMenu().setVisible(true);
             
        }else{
            JOptionPane.showMessageDialog(null, "Error en Usuartio o Contraseña,Numeros de Intentos"+conta);
            if(conta>=3){
               System.exit(0);
            }else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(proyAcceso.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new proyAcceso().setVisible(true);
            }
        });
    }
